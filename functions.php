<?php
  ...
  */
  function bae_scripts() {
    ...
    wp_enqueue_script( 'appjs', get_template_directory_uri() . '/assets/js/min/app.js', array('jquery-v2'),'', true );
    wp_register_script( 'bootstrapJS', get_template_directory_uri() . '/assets/js/min/bootstrap.min.js', array('jquery-v2'),'', true );
    if (is_home()) {
