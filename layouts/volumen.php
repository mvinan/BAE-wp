            ...
            <div class="volumenActivities-listContainer container">
              ...
              if( $all_activities && $all_activities != 0) {
                  ...
                  foreach ( $all_activities as $activity ) { ?>
                    <a href="<?php echo get_permalink( $activity->ID ) ?>" class="activity">
                      <h3> <?php echo get_the_title( $activity->ID) ?> </h3>
                      <div class="meta">
                        <p><strong><?php echo get_the_time('j F, Y', $activity->ID ); ?></strong></p>
                        <span href="<?php echo get_permalink( $activity->ID ) ?>" class="btn-go"><i class="fa fa-arrow-circle-right"></i></span>
                      </div>
                    </a>
                    <?php
                  }
            ...
            <div class="volumenAuthors-listContainer container">
              ...
              if( $all_authors ) {
                  foreach ( $all_authors as $author ) { ?>
                    <a href="<?php echo get_permalink( $author->ID ) ?>" class="activity">
                      <h3> <?php echo get_the_title( $author->ID) ?> </h3>
                      <div class="meta">
                        <p><strong><?php echo the_field('nacimiento_fallecimiento', $author->ID); ?></strong></p>
                        <span href="<?php echo get_permalink( $author->ID ) ?>" class="btn-go"><i class="fa fa-arrow-circle-right"></i></span>
                      </div>
                    </a>
                    <?php
                  }
